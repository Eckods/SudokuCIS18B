...
public class MainFrame extends JFrame{
    ...
    private void createGrid(){
        rowData = new Object[][] {{ "5", "3", "4", "6", "7", "8", "9", "1", "2" },
            { "5", "3", "4", "6", "7", " ", "9", "1", "2" },
            { "5", "3", "4", "6", "7", "8", "9", "1", "2" },
            { "5", "3", "4", "6", "7", "8", "9", "1", "2" },
            { "5", "3", "4", "6", "7", "8", "9", "1", "2" },
    ...
    public static void generateGameBoard(){
        ...
        int sudokuForbidden [][];
        sudokuForbidden = new int [9][9];
        
        for(int column = 0; column <9;column++){
            for(int row =0; row < 9;row++){
                   rNumber = (int)(2*Math.random());
                   sudokuUserPuzzle [column][row]=rNumber;
                   sudokuForbidden [column][row]=rNumber;
            }
        }
        for(int r=0;r<9;r++){
            if(r==0){
        ...
        for(int column = 0; column <9;column++){
            for(int row =0; row < 9;row++){
                if(sudokuUserPuzzle[column][row]!=0){
                    ...
                    num = "" + sudokuUserPuzzle[column][row];
                    rowData[column][row] = num;
                }else{
